...
public class KPSPublicSoapProxy implements MernisSerirviceReference.KPSPublicSoap {
  private String _endpoint = null;
  private MernisSerirviceReference.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new MernisSerirviceReference.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public MernisSerirviceReference.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
