...
public class KPSPublicLocator extends org.apache.axis.client.Service implements MernisSerirviceReference.KPSPublic {
    ...
    public MernisSerirviceReference.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public MernisSerirviceReference.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MernisSerirviceReference.KPSPublicSoapStub _stub = new MernisSerirviceReference.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MernisSerirviceReference.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                MernisSerirviceReference.KPSPublicSoapStub _stub = new MernisSerirviceReference.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
